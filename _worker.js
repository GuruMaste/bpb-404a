...
// @ts-ignore
// https://github.com/GuruMaste/bpb-404s
...
function getVLESSConfig(userIDs, hostName) {
	...
	const output = userIDArray.map((userID) => {
		...
		return `################################################################
Telegram Channel! ==> https://t.me/shineko6
---------------------------------------------------------------
Contact to developer ==> https://t.me/shineko6
---------------------------------------------------------------
Developed script by Bhone Thant Kyaw
################################################################
<h2>UUID: ${userID}</h2>
...
`;
	...
	// Prepare header string
	const header = `
<p align='center'><img src='https://images.app.goo.gl/4PWuXpS8nBzBbfH96' alt='' width="150" height="150" style='margin-bottom: -0px;'>
<b style='font-size: 15px;'>Welcome! This function generates configuration for BTK protocol. If you found this useful, please join our Telegram channel for more:</b><br>
<b style='font-size: 15px;'>Shinko</b>
<a href='https://t.me/shineko6' style="color: #fff;font-size: 15px;background-color: #5cb85c;" target='_blank'>Click To Join Telegram Channel</a>
...
<a href='https://github.com/GuruMaste/bpb-404s' target='_blank'>4̷-◉-4̷</a>
	...
	const output = userIDArray.flatMap((userID) => {
		if (format === 'qx') {
			...
			const httpsConfigurations = Array.from(portSet_https).flatMap((port) => {
				...
				const thHttps = 'vless=th.' + port + '.' + host + ':' + port + ',method=none,password=' + userID + ',obfs=wss,obfs-uri=/?ed=2048,obfs-host=' + hostName + ',tls-verification=true,tls-host=' + hostName + ',fast-open=false,udp-relay=false,tag=🇹🇭 TH_' + port;
				...
				return [sgHttps, hkHttps, krHttps, jpHttps, usHttps, twHttps, thHttps, cfHttps];
			});
	...
	<body>
		...
		<div class="form-container">
			...
			<div class="table-container">
                <table id="frag-sub-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/bestip/${userID}?uuid=${userID}#404 Subscription', '404 Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/bestip/${userID}?uuid=${userID}#404 Subscription', true)">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/bestip/${userID}?uuid=${userID}?app=hiddify#404-Subscription', '404 Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/bestip/${userID}?uuid=${userID}?app=hiddify#404-Subscription', true)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
                    </tr>
			...
			<div class="table-container">
                <table id="frag-sub-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/sub/bestip/${userID}?uuid=${userID}#404 Subscription', '404 Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/sub/bestip/${userID}?uuid=${userID}#404 Subscription', true)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/sub/bestip/${userID}?uuid=${userID}?app=hiddify#404-Subscription', '404 Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/sub/bestip/${userID}?uuid=${userID}?app=hiddify#404-Subscription', true)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
                    </tr>
            ...
            <div class="footer">
                ...
                <a class="link" href="https://github.com/nyeinkokoaung404/tunnel404" style="color: var(--color); text-decoration: underline;" target="_blank">Github</a>
